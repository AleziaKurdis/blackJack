...
// Modified by Alezia Kurdis for the Black Jack Game.
//
...
//
// Allows avatars to sit in Overte after clicking on a local entity or on the chair to play Black Jack. Works with sitServer.js.
//
    ...
    function deleteChair() {
        ...
        if (chairID === Uuid.NULL) {
            chairID = Entities.addEntity({
                ...
                "parentID": _this.entityID,
                "type": "Model",
                "name": "Black Jack Chair",
                "dimensions": {
                    "x": 0.5059115886688232,
                    "y": 1.0777661800384521,
                    "z": 0.60999995470047
                },
                "localRotation": Quat.fromVec3Degrees({"x": 0.0, "y": -90,"z": 0.0}),
                "local Position": {"x": -0.0519, "y": -0.8773, "z": 0.0},
                "grab": {
                    "grabbable": false
                },
                "shapeType": "none",
                "modelURL": ROOT + "resources/models/univestool_arms_blackJack.fst",
